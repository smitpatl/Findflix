...
public class LikesActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<searchService.ResultWithDetail>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Set movieLikes = prefs2.getStringSet("movie_like", null);
        ArrayList<String> list = new ArrayList<>(movieLikes);
        mMovieTitle = list;
    ...
    public Loader<searchService.ResultWithDetail> onCreateLoader(int id, Bundle args) {
        return new SavedLoader(LikesActivity.this, args.getStringArrayList("movieTitle"));
    }
    ...
    public class MovieRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            Picasso.with(LikesActivity.this).load(imageUrl).into(holder.mThumbImageView);

            holder.mView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(LikesActivity.this, DetailActivity.class);
                    ...
                    ActivityOptionsCompat options = ActivityOptionsCompat.
                            makeSceneTransitionAnimation(LikesActivity.this,
